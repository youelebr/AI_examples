...
def conv(img, conv_filter):
    ...
    # print("conv_filter.shape.len: ", len(conv_filter.shape))
    # print("conv_filter.shape: ", conv_filter.shape)
    # for i in range (0, len(conv_filter.shape)):
        # print("conv_filter.shape[",i,"]: ",conv_filter.shape[i])

    # print("img.shape.len: ",len(img.shape))
    # print("img.shape: ", img.shape)
    # for i in range (0, len(img.shape)):
    #     print("img.shape[",i,"]: ",img.shape[i])
